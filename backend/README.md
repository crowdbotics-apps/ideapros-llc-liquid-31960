...
## Project Structure
    ...
    ├── ideapros_llc_liquid_31960  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_liquid_31960`
...
2. Clone this repo and `cd ideapros_llc_liquid_31960`
